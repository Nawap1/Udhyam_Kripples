...
function calculateCharge(distanceInKilometers) {
    let charge = 0;
    if (distanceInKilometers >= 0 && distanceInKilometers <= 10) {
        charge = 20;
    } else if (distanceInKilometers > 10 && distanceInKilometers <= 15) {
        charge = 25;
    } else if (distanceInKilometers > 15 && distanceInKilometers <= 20) {
        charge = 30;
    } else if (distanceInKilometers > 20 && distanceInKilometers <= 25) {
        charge = 40;
    } else if (distanceInKilometers > 25 && distanceInKilometers <= 30) {
        charge = 50;
    }
    return charge;
}
...
function runDirection(start, end) {
    ...
    dir.on('success', function (data) {
        if (data && data.route && data.route.distance !== undefined) {
            ...
            // Show the info-box-7
            const infoBox7 = document.querySelector('.info-box-7');
            infoBox7.style.display = 'block';
